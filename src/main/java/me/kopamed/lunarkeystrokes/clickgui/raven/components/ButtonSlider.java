...
public class ButtonSlider extends Component {
   ...
   public void draw() {
      ...
      net.minecraft.client.gui.Gui.drawRect(l, this.p.category.getY() + this.o + 11, r, this.p.category.getY() + this.o + 15, new Color((int)Gui.ar.getInput(), (int)Gui.ag.getInput(), (int)Gui.ab.getInput()).getRGB());
      GL11.glPushMatrix();
      GL11.glScaled(0.65D, 0.65D, 0.65D);
      Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.v.getName() + ": " + this.v.getInput(), (float)((int)((float)(this.p.category.getX() + 4) / 0.65F)), (float)((int)((float)(this.p.category.getY() + this.o + 3) / 0.65F)), -1);
      GL11.glPopMatrix();
   }
