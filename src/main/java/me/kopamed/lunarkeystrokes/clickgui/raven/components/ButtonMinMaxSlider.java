...
public class ButtonMinMaxSlider extends Component {
    ...
    public void draw(){
        ...
        net.minecraft.client.gui.Gui.drawRect(startToDrawFrom, this.module.category.getY() + this.moduleStartY + textSize, finishDrawingAt, this.module.category.getY() + this.moduleStartY + textSize + boxHeight, new Color((int)Gui.ar.getInput(), (int)Gui.ag.getInput(), (int)Gui.ab.getInput()).getRGB());
        ...
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.doubleSlider.getName() + ": " + this.doubleSlider.getInputMin() + ", " + this.doubleSlider.getInputMax(), (float)((int)((float)(this.module.category.getX() + 4) / 0.65F)), (float)((int)((float)(this.module.category.getY() + this.moduleStartY + 3) / 0.65F)), -1);
        GL11.glPopMatrix();
    }
