...
public class ButtonMode extends Component {
    ...
    public void draw() {
        ...
        int bruhWidth = (int) (Minecraft.getMinecraft().fontRendererObj.getStringWidth(this.mode.getName() + ": ") * 0.65);
        Minecraft.getMinecraft().fontRendererObj.drawString(this.mode.getName() + ": ", (float) ((this.p.category.getX() + 4) / 0.6), (float) ((this.p.category.getY() + this.o + 4) / 0.6), 0xffffffff, true);
   
        Minecraft.getMinecraft().fontRendererObj.drawString(this.mode.getMode(), (float) ((this.p.category.getX() + 4 + bruhWidth) / 0.6), (float) ((this.p.category.getY() + this.o + 4) / 0.6), this.c, true);
        GL11.glPopMatrix();
    }
