...
public class Utils {
   ...
   public static class HUD {
      ...
      public static void ee(Entity e, int type, double expand, double shift, int color, boolean damage) {
         if (e instanceof EntityLivingBase) {
            ...
            if (type == 3) {
               ...
               if (color != 0) {
            	   dr(-22, 2, 2, 71, color);//left
                   
                   dr(20, 2, 2, 71, color);//right
                   
                   dr(-22, 2, 44, 2, color);//top
                   
                   dr(-22, 72, 44, 2, color);//bottom
               } else {
               ...
               if (type == 4) {
                  ...
                  dr(i, 2, 3, 72, Color.black.getRGB());
                  dr(i, 2, 3, b, hc);
                  GlStateManager.enableDepth();
               } else if (type == 6) {
      ...
      private static void dr(int x, int y, int w, int h, int c) {
    	  net.minecraft.client.gui.Gui.drawRect(x, y, x + w, y + h, c);
      }
